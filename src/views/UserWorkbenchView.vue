...
const menuGroups: WorkbenchMenuGroup[] = [
    {
        ...
        icon: Connection,
        items: [
            { label: '我的需求单', name: 'workbench', hash: '#requirements', description: '查看支付、交付与验收进度' },
    ...
    },
    {
        ...
        icon: Box,
        items: [
            { label: '账户与优惠券', name: 'workbench', hash: '#coupons', description: '管理优惠券与账户入口' },
...
<template>
    <main class="user-workbench">
        ...
        <section class="user-workbench__main">
            <header class="user-workbench__head">
                <div>
                    <p>{{ currentEyebrow }}</p>
                    <h1>{{ currentTitle }}</h1>
