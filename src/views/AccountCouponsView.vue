...
<template>
    <main class="page-shell custom-page-shell profile-page account-coupons-page">
        <section class="wallet-section account-coupons-summary">
            <div class="wallet-header account-coupons-summary__head">
                <div>
                    <h3>账户与优惠券</h3>
                    <small class="requirement-note">{{ auth.username || '当前账号' }} · {{ accountEmailLabel }}</small>
                </div>
                <button class="ghost small" type="button" :disabled="profileLoading || couponLoading"
                    @click="refreshAccountCoupons">
                    {{ profileLoading || couponLoading ? '刷新中...' : '刷新' }}
                </button>
            </div>

            <div class="account-coupons-summary__grid">
                <article>
        ...
        <section class="wallet-section account-settings-section">
            <div class="wallet-header">
                ...
                <button class="ghost small" type="button"
                    @click="router.push({ name: 'workbench-realname' })">实名认证</button>
            </div>
                    ...
                    <div class="subscription-settings">
                        <label class="subscription-card account-subscription-card">
                            ...
                            <span class="subscription-switch-wrap">
                                <input v-model="subscriptionOfficialActivity" class="subscription-switch-input"
                                    type="checkbox" :disabled="subscriptionLoading" />
                        ...
                        <div class="subscription-actions">
                            <button class="ghost small" type="button" :disabled="subscriptionLoading"
