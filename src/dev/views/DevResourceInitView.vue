...
<template>
    <div class="dev-page dev-page--publish">
        <section class="dev-panel-banner dev-panel-banner--light">
            <div>
                <div class="dev-panel-banner__eyebrow">MC Resource Init</div>
                <h2 class="dev-panel-banner__title">资源初始化</h2>
                <p class="dev-panel-banner__desc">资源项目初始化后默认保持私有，可直接用于关联需求；如果要公开展示，需要后续单独提交审核。</p>
            </div>
        </section>
